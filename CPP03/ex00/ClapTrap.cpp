...
/*   Updated: 2023/12/11 12:05:57 by framos-p         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::attack(const std::string &target)
{
	if (energyPoints == 0 || hitPoints == 0) 
		std::cout << "ClapTrap " << name << " can't attack " << target << " because of low energy points or its destroyed!" << std::endl;
	else
	{
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	if (hitPoints == 0 || energyPoints == 0)
		std::cout << "ClapTrap " << name << " can't be repaired because it is destroyed or doesn't have enough energy!" << std::endl;
	else
	{
		hitPoints += amount;
